...
/**
 * Page Object Model for the Origin Downtime management page (/origin/downtime).
 *
 * Encapsulates all selectors and interactions so tests stay readable and
 * resilient to minor UI changes.
 */
export class OriginDowntimePage {
  readonly page: Page;
  ...
  // Modal elements (only present while modal is open)
