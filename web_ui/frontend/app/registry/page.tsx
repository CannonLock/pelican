        ...
        <Box width={"100%"}>
            <Grid container spacing={2}>
                ...
                <Grid item xs={12} lg={8} justifyContent={"space-between"}>
                    ...
                    }
                    {
                        ...
                        <Grid item xs={12}>
                            <Paper sx={{p:2, borderColor: "primary.main", borderWidth: "3px", borderType: "solid"}} elevation={3}>
                                ...
                                <CardList namespaces={pendingData} Card={PendingCard} cardProps={{authenticated:user, onAlert: (a: AlertType) => setAlert(a), onUpdate:_setData}}/>
                            </Paper>
                        </Grid>
                    }
                    ...
                    { approvedOriginData !== undefined ? <CardList namespaces={approvedOriginData} Card={Card} cardProps={{authenticated: user}} /> : <CardSkeleton/> }
                    ...
                    { approvedCacheData !== undefined ? <CardList namespaces={approvedCacheData} Card={Card} cardProps={{authenticated: user}} /> : <CardSkeleton/> }
